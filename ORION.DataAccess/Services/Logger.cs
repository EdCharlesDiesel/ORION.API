...
namespace ORION.DataAccess.Services
{
    ...
    {
        private OrionDbContext _DatabaseContext;
        private IFeatureManager _FeatureManager;
        private IHttpContextAccessor _ContextAccessor;

        public Logger(IHttpContextAccessor contextAccessor, IOrionDbContext databaseContext, IFeatureManager featureManager)
        {
